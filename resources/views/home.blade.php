...
<link rel="stylesheet" type="text/css" href="/layout_site/styles/bootstrap-4.1.2/bootstrap.min.css">
<link href="/layout_site/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="/layout_site/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="/layout_site/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="/layout_site/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="/layout_site/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="/layout_site/styles/responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-center">
			<div class="logo"><a href="#">Ritz.fy</a></div>
			<div class="log_reg">
	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="owl-item">
					<div class="background_image" style="background-image:url(/layout_site/images/index.jpg)"></div>
					<div class="home_container">
						<div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
							<div class="home_content text-center">
								<div class="home_subtitle">Novas faixas disponíveis</div>
								<div class="home_title"><h1>Os melhores Ritz em um só lugar</h1></div>
								<div class="home_link"><a href="#">Minhas curtidas</a></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="featured_album">
		<div class="background_image featured_background" style="background-image:url(/layout_site/images/featured.png)"></div>
		<div class="container">
			<div class="row">
			...
			<div class="row featured_row row-lg-eq-height">
				...
				<div class="col-md-6">
					<div class="featured_album_image">
						...
						<div class="background_image" style="background-image:url(/layout_site/images/featured_album.jpg)"></div>
						<!-- <img src="/layout_site/images/featured_album.jpg" alt=""> -->
					</div>
				</div>
			...
			<div class="row shows_row">
				...
				<div class="col-lg-4 order-lg-2 order-1">
					<div class="shows_image">
						<div class="image_overlay"></div>
						<img src="/layout_site/images/shows.jpg" alt="https://unsplash.com/@anthonydelanoix">
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 artist_image_col">
					<div class="artist_image">
						<img src="/layout_site/images/artist.png" alt="">
					</div>
				</div>
				...
				<div class="col-lg-7 offset-lg-1">
					<div class="artist_content">
						...
						<div class="artist_sig"><img src="/layout_site/images/sig.png" alt=""></div>
	...
	<div class="extra">
		<div class="extra_container">
			<div class="background_image" style="background-image:url(/layout_site/images/extra.jpg)"></div>
			<div class="container">
				<div class="row">
					<div class="col-lg-9">
...
<script src="/layout_site/js/jquery-3.2.1.min.js"></script>
<script src="/layout_site/styles/bootstrap-4.1.2/popper.js"></script>
<script src="/layout_site/styles/bootstrap-4.1.2/bootstrap.min.js"></script>
<script src="/layout_site/plugins/greensock/TweenMax.min.js"></script>
<script src="/layout_site/plugins/greensock/TimelineMax.min.js"></script>
<script src="/layout_site/plugins/scrollmagic/ScrollMagic.min.js"></script>
<script src="/layout_site/plugins/greensock/animation.gsap.min.js"></script>
<script src="/layout_site/plugins/greensock/ScrollToPlugin.min.js"></script>
<script src="/layout_site/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="/layout_site/plugins/easing/easing.js"></script>
<script src="/layout_site/plugins/progressbar/progressbar.min.js"></script>
<script src="/layout_site/plugins/parallax-js-master/parallax.min.js"></script>
<script src="/layout_site/plugins/jPlayer/jquery.jplayer.min.js"></script>
<script src="/layout_site/plugins/jPlayer/jplayer.playlist.min.js"></script>
<script src="/layout_site/js/custom.js"></script>
</body>
</html>